...
''poor health'' und ''excellent health'' sind jeweils neue Faktoren als Verhältnis zu ''average health''.

Es zeigt sich dass ''poor health'' positiv mit Arztbesuchen korreliert ist und ''excellent health'' negativ korreliert.
...
Die Parameter ''verheiratet'' und ''staatliche Unterstützung'' weisen keine signifikante statsitische Auswirkung auf.

## b)

```{r}
y = plm$coefficients[1] + 2 * plm$coefficients[4] + plm$coefficients[6]

y
```

Man kann $`r round(y, 0)`$ Arztbesuche erwarten.
